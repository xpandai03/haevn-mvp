...
export const surveySections: SurveySection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q_age_min',
        csvId: 'Q_AGE_MIN',
        label: 'What is the youngest age you\'d like to be matched with?',
        type: 'number',
        min: 18,
        max: 120,
        placeholder: 'e.g. 25',
        required: false,
        helperText: 'People outside your preferred age range will not appear in your matches.',
      },
      {
        id: 'q_age_max',
        csvId: 'Q_AGE_MAX',
        label: 'What is the oldest age you\'d like to be matched with?',
        type: 'number',
        min: 18,
        max: 120,
        placeholder: 'e.g. 45',
      ...
      {
        id: 'q_race_identity',
        csvId: 'Q_RACE_IDENTITY',
        label: 'How do you identify racially or ethnically?',
        type: 'multiselect',
        options: [
          'Asian',
        ...
        required: false,
        helperText: 'Select all that apply. This helps us respect your match preferences.',
      },
      {
        id: 'q_race_preference',
        csvId: 'Q_RACE_PREFERENCE',
        label: 'Do you have a preference for your matches\' race or ethnicity?',
        type: 'multiselect',
        options: [
          'Any',
          'Asian',
        ...
        required: false,
        helperText: 'Select "Any" if you have no preference. Selecting specific races without "Any" will filter your matches.',
      },
      {
