...
export default function PronounsPage() {
  ...
  const showCustomInput = selectedPronouns === 'Custom'
  const isFormValid = selectedPronouns && (!showCustomInput || customPronouns.trim())

  const handleContinue = () => {
    if (isFormValid) {
      const pronounsValue = showCustomInput ? customPronouns : selectedPronouns
      console.log({ pronouns: pronounsValue })
      router.push('/onboarding/sexual-orientation')
    }
  }
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pb-12">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-lg p-8 lg:p-12">
          ...
          <div className="flex items-start gap-3 mb-8">
            ...
            >
              Which pronouns do you want others to use for you?
            </h1>
            ...
            <TooltipProvider>
              <Tooltip open={showInfoPopover} onOpenChange={setShowInfoPopover}>
                ...
                >
                  ...
                  >
                    Examples: she/her, he/him, they/them, or a custom set.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          {/* Pronouns selection cards */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
            {PRONOUN_OPTIONS.map((pronoun) => (
              <button
                key={pronoun}
                onClick={() => setSelectedPronouns(pronoun)}
                className={`
